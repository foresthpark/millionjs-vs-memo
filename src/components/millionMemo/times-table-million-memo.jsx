...
const TableViewMemo = lazy(() => import("./table-view-million-memo"));
...
const TimesTableMillionMemo = ({ nodes, mode }) => {
  ...
  return (
    <Stack direction="column" spacing={5}>
      ...
      >
        <TableViewMemo array={array} count={count} mode={mode} />
      </Suspense>
    </Stack>
  );
};

export default TimesTableMillionMemo;
